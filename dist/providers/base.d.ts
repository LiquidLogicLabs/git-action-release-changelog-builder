...
export declare abstract class BaseProvider {
    ...
    protected constructor(token: string, baseUrl: string | undefined, repositoryPath: string);
    /**
     ...
     */
    abstract getForCommitHash(owner: string, repo: string, commitSha: string, maxPullRequests: number): Promise<PullRequestInfo[]>;
    /**
